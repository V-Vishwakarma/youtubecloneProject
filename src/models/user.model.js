...
// pre is the hook which is used to perform some action before saving the data in the database it is monogoose middleware
// if any data any modified this will save the password again and again to prevent this we are using the isModified method
// isModified is used to chechk is the particular filed saved or not
...
// this will check password is correct or not beaucse user give passwword on login are in simple string format
// and we have hashed password in the database so we need to compare the password with the hashed password
